...
//                         Programas De Mentoring Organizacional Y Profesional{" "}
//                       </p>
//                     </li>
//                     <li className="flex justify-start  items-center">
...
const HomePage = () => {
  ...
  // Variantes de animación para las tarjetas individuales (alianzas)
  const cardVariants = {
    ...
    <div className="pb-10">
      ...
      <div className="space-y-10 -mt-[6rem]">
        ...
        <motion.section
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }} // Anima una vez cuando el 30% del elemento está visible
        >
          <Card className="bg-white shadow-lg">
            <CardContent>
              <div className="space-y-2 pt-6">
        ...
        >
          <Card className="bg-white shadow-lg">
            <CardContent>
              ...
              {/* Contenedor para las alianzas con animación escalonada */}
              <motion.div
                className="pt-3 grid place-items-center grid-cols-1 lg:grid-cols-2 gap-2 md:gap-4 lg:gap-x-8 :gap-y-4"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
                transition={{ staggerChildren: 0.2 }} // Retrasa la animación de los hijos
              >
                {Alianzas.map((alianza, key) => (
                  <motion.a
                    href={alianza.link}
                    ...
                    rel="noopener noreferrer"
                    className="w-full max-w-72 shadow-lg"
                    variants={cardVariants} // Aplica las variantes de tarjeta a cada enlace de alianza
                  >
                    <div className=" hover:-translate-y-2 shadow-md border  rounded-lg   bg-[#004f51] border-[#004f51]">
                      <figure className="relative w-full h-[18rem]">
                        <Image
                          ...
                          fill
                          alt={alianza.nombre} // Mejorar el texto alternativo para accesibilidad
                        />
                      </figure>
                      <div className="p-4 h-32">
                        <div>
